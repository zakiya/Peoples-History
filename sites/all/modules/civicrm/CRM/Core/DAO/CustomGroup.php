...
class CRM_Core_DAO_CustomGroup extends CRM_Core_DAO
{
     ...
     *
     * @var enum('Contact', 'Individual', 'Household', 'Organization', 'Location', 'Address', 'Contribution', 'Activity', 'Relationship', 'Phonecall', 'Meeting', 'Group', 'Membership', 'Participant', 'Event')
     */
    public $extends;
    /**
