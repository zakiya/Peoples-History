...
<?php echo $IE6pingFix; if ($IE6pingFix) {?><link rel="stylesheet" href="<?php print $asset_path ?>/ie6-fix.css" type="text/css" />
<?php }?>
...
<div class="page <?php print $siteArchitecture!=""?$siteArchitecture:(arg(0)."-theme") ?>" id="<?php print $node->type?$node->type:"untyped-page"; ?>">
	<!-- start header -->
